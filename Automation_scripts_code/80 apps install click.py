...
# Wait for the "Install" button to appear for up to 10 seconds
install_button = device(description="Install").wait(timeout=10)

# Check if install_button is True (element found)
if install_button:
